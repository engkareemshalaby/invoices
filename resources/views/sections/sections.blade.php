...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الأقسام</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الإعدادات</span>
						</div>
					</div>
	...
	<div class="card">
		<div class="card-header pb-0">
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-slide-in-bottom" data-toggle="modal" href="#select2modal">إضافة قسم + </a>
			</div>		
		</div>
		<div class="card-body">
					...
					<tbody>
							...
							@foreach ($sections as $section)
								<tr>
									...
									@endphp
									<td col-md-4>{{$i}}</td>
									<td col-md-4>{{$section->section_name}}</td>
									<td col-md-4>{{$section->description}}</td>
									<td col-md-4>
						...
						<div class="modal-body">
							<form action="{{route('sections.store')}}" method="POST">
								...
								<div class="form-group">
									...
									<textarea type="text" class="form-control" name="section_description" id="section_description"></textarea>
								</div>
